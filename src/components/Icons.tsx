...
/**
 * Line chart — Tabler Icons `chart-line` (same geometry as `public/icons/tabler_chart-line.svg`; `currentColor` for active/inactive).
 */
export function IconChartLine({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M20 19H4M20 15L16 9L12 11L8 6L4 10"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
/**
 * Bar chart — `bar-chart-2-linear` (same geometry as `public/icons/bar_chart-2-linear.svg`; `currentColor` for active/inactive).
 */
export function IconChartBar({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M19.2002 20H4.8002"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M19.2002 11.2C19.2002 10.4456 19.2002 10.0688 18.9658 9.8344C18.7314 9.6 18.3546 9.6 17.6002 9.6C16.8458 9.6 16.469 9.6 16.2346 9.8344C16.0002 10.0688 16.0002 10.4456 16.0002 11.2V16C16.0002 16.7544 16.0002 17.1312 16.2346 17.3656C16.469 17.6 16.8458 17.6 17.6002 17.6C18.3546 17.6 18.7314 17.6 18.9658 17.3656C19.2002 17.1312 19.2002 16.7544 19.2002 16V11.2ZM13.6002 8C13.6002 7.2456 13.6002 6.8688 13.3658 6.6344C13.1314 6.4 12.7546 6.4 12.0002 6.4C11.2458 6.4 10.869 6.4 10.6346 6.6344C10.4002 6.8688 10.4002 7.2456 10.4002 8V16C10.4002 16.7544 10.4002 17.1312 10.6346 17.3656C10.869 17.6 11.2458 17.6 12.0002 17.6C12.7546 17.6 13.1314 17.6 13.3658 17.3656C13.6002 17.1312 13.6002 16.7544 13.6002 16V8ZM8.0002 5.6C8.0002 4.8456 8.0002 4.4688 7.7658 4.2344C7.5314 4 7.1546 4 6.4002 4C5.6458 4 5.269 4 5.0346 4.2344C4.8002 4.4688 4.8002 4.8456 4.8002 5.6V16C4.8002 16.7544 4.8002 17.1312 5.0346 17.3656C5.269 17.6 5.6458 17.6 6.4002 17.6C7.1546 17.6 7.5314 17.6 7.7658 17.3656C8.0002 17.1312 8.0002 16.7544 8.0002 16V5.6Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
